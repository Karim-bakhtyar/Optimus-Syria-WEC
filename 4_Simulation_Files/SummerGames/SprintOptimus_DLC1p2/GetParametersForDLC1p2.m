...
% files
StatisticsFile      	= 'SteadyStates_3p4MW.mat';
...
% template files
InputFiles{1,1}         = 'IEA-3.4-130-RWT_FB.fst';            % main file
InputFiles{2,1}         = 'IEA-3.4-130-RWT_ElastoDyn.dat';  % to adjust initial conditions
InputFiles{3,1}         = 'IEA-3.4-130-RWT_InflowFile.dat';          % to adjust wind speed
