...
URef_vector         = 20;  %4:2:24;   % [m/s]         range of wind speeds (operation points)
n_Seed              = 1;        % [-]           number of stochastic turbulence field seeds
...
TurbSimTemplateFile = 'OptimusSyria_Turbsim.inp';
