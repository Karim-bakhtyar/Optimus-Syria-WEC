...
% only updated for feedback only
% inputs
arguments
...
% files
StatisticsFile      	= 'SteadyStatesTable_Final.mat';

% Variation
PreProcessingVariation  = { 'URef',[8:4:24],'%02d';
                            'Seed',[1:3]   ,'%02d'};

% template files
InputFiles{1,1}         = 'OPTSyria5MW.fst';            % main file
InputFiles{2,1}         = 'OPTSyria5MW_ElastoDyn.dat';  % to adjust initial conditions
InputFiles{3,1}         = 'OPTSyria5MW_Inflow.dat';          % to adjust wind speed
...
Modifications           = {
                        ...
                        % '3','I','TowerFile',	        @(VariationValues)strcat('TurbulentWind/URef_',num2str(VariationValues(1),'%02d'),'_Seed_',num2str(VariationValues(2),'%02d'))
                        };
