...
URef_vector         = 8:4:24;   % [m/s]         range of wind speeds (operation points)
n_Seed              = 3;        % [-]           number of stochastic turbulence field seeds
...
TurbSimTemplateFile = 'OptSyria_TurbsimInput.inp';
