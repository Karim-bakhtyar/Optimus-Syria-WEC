...
OutputFile = 'TurbulentWind/20ms_coherence';
...
load("4Beam_Coordinates.mat");

% m = 5; % target step
% 
% x = -m * round(XYZ_grid.x(1:4) / m);
% y = -m * round(XYZ_grid.y(1:4) / m);
% z = -m * round(XYZ_grid.z(1:4) / m);
% 
...
y_1 = 22;   % Beam 1: right % 
y_2 = 22;  % Beam 2: left
y_3 = -22;    % Beam 3: center (vertical up)
y_4 = -22;    % Beam 4: center (vertical down)

z_1 = 18;    % Beam 1: horizontal % 15.522
z_2 = -18;    % Beam 2: horizontal
z_3 = -18;   % Beam 3: up
z_4 = 18;  % Beam 4: down
...
fprintf('\nCoherence metrics:\n')
fprintf('  Modified Coherence Bandwidth (MCB): %.5f rad/m\n', MCB)
fprintf('  Smallest Detectable Eddy Size (SDES): %.3f (normalized by 2R)\n', SDES)
